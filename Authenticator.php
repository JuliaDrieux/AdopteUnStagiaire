...
class Authenticator{
     ...
     * @return bool 
     */
    public function tryLogin($uid, $password){
        $dbpassword = $auth.findUserPasswordHash(); // TODO implement fetch method 
        return $dbpassword && password_verify($password, $dbpassword);
    }
