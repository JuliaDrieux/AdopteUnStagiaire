...
class Router
{
  ...
  /**
   * Reference to the server's repository abstraction layer
   * @var Repository
   */
  private $db;
   ...
   * @param Repository $db The server's repository
   * @param Authenticator $auth The server's authenticator
   */
  function __construct(Request $request, Repository $db, Authenticator $auth)
  {
